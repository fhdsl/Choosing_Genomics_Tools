...
```{r, fig.alt = "This chapter will demonstrate how to: Understand the very general basics of microarray data collection and processing workflow. Understand the limitations and strengths of microarray data in general.", echo = FALSE}
