...
These tools are used to identify either somatic or germline mutations from a sequenced sample. Many researchers will often use a combination of these tools to narrow down only variants that are identified using a combination of these analysis algorithms
...
Researchers may want to create a consensus file based on the mutation calls using multiple tools above. [OpenPBTA-analysis](https://github.com/AlexsLemonade/OpenPBTA-analysis/tree/master/analyses/snv-callers) is a tool that can be used for this purpose. It takes MAF files generated from the above mutation callers and identifies the overlapping hits. 
...
These tools are often used in parellel to look at regions of the genome, develop plots, and create other relevant figures:  
