...
- [MuSE](https://bioinformatics.mdanderson.org/public-software/muse/) This is a mutation calling tool that uses a Markov Substitution model for Evolution, which models the evolution of the allelic composition of the tumor and normal tissue at each reference base. 
- [Svaba]()
- [Strelka]()
- [SomaticSniper]()
- [Pindel]()
