...
- This course can be taken on [Coursera for certification for a fee here](https://www.coursera.org/specializations/researchers-guide-to-omic-data/) (but it is not available for free on Coursera).
